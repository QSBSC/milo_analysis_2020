...
```{r}
# install.packages("babelgene", type = "source")
...
We downloaded the dataset and annotations stored in Seurat object from [here](https://datashare.is.ed.ac.uk/handle/10283/3433), as indicated by the authors. The files are on DropBox and can be accessed directly with the code below.
...
**NOTE: This takes a while to process! Can take >30 min.**
